...
npx hardhat mint-model-id --network localhost --id '0' --model 'sample-models/10x10.json' --contract '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0' --maxlen 1000
npx hardhat mint-model-id --network localhost --id '1' --model 'sample-models/32x32_cifar.json' --contract '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0' --maxlen 10000
...
npx hardhat eval-img --network localhost --id '1' --offline true --contract '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0' --img 'sample-images/cifar10/airplane/0000.jpg'
