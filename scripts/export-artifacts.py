...
MODEL_COLLECTION_ARTIFACT_DIR = "artifacts/contracts/ModelCollection.sol"
MODEL_COLLECTION_OUTPUT = "model-collection"
...
if __name__ == "__main__":
    ...
    with open(os.path.join(OUTPUT_FOLDER, "__init__.py"), "w") as f:
        f.write("")
    process_artifacts(MODEL_COLLECTION_ARTIFACT_DIR, os.path.join(OUTPUT_FOLDER, MODEL_COLLECTION_OUTPUT))
