...
npx hardhat mint-model-id --network anvil --id '2' --model 'sample-models/shakespeare_lstm.json' --contract '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0' --maxlen 10000
