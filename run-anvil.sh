...
npx hardhat deploy --tags 4 --network anvil
...
npx hardhat mint-model-id --network anvil --id '2' --model 'sample-models/shakespeare_simplernn.json' --contract '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0' --maxlen 10000
...
npx hardhat generate-text --network anvil --id '2' --contract '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0' --prompt $'Q' --togenerate 10 --cuda 0
