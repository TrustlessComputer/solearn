...
npx hardhat mint-model-id --network regtest2 --id '2' --model 'sample-models/shakespeare_lstm_small.json' --contract '0xCF71Bf8F3FaAa66546c5C9b4E2Dd8C34078Aac70' --maxlen 10000
...
npx hardhat generate-text --network regtest2 --id '2' --contract '0xCF71Bf8F3FaAa66546c5C9b4E2Dd8C34078Aac70' --prompt $'ROMEO:\nIs the day so young?' --togenerate 50
