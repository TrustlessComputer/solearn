...
# mint model ID
npx hardhat mint-model-id --network regtest --model 'sample-models/cnn_10x10_small.json' --id '2' --contract '0x3Ef48814d91D79927d16dA531931E1D6080cdcdE'
npx hardhat mint-model-id --network regtest --model 'sample-models/cnn_10x10_mini.json' --id '3' --contract '0x3Ef48814d91D79927d16dA531931E1D6080cdcdE'
# npx hardhat mint-model-id --network regtest --model 'sample-models/cnn_10x10.json' --id '4' --contract '0x3Ef48814d91D79927d16dA531931E1D6080cdcdE'
