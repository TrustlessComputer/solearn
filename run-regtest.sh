...
npx hardhat eval-img --network regtest --id '1' --offline true --contract '0x6dc2bB742561bB07eA8B22fA3C047F403b26456c' --img 'sample-images/cifar10/airplane/0000.jpg'
npx hardhat eval-img --network regtest --id '1' --offline false --contract '0x6dc2bB742561bB07eA8B22fA3C047F403b26456c' --img 'sample-images/cifar10/airplane/0000.jpg'
