...
npx hardhat mint-model-id --network regtest --model 'sample-models/cnn_10x10.json' --id '5' --contract '0x639453f46C75C1b4a43a8FdBA27B03b916748a44'
...
npx hardhat eval-img --network regtest --id '5' --offline true --contract '0x639453f46C75C1b4a43a8FdBA27B03b916748a44' --img 'sample-images/10x10/cryptoadz/000.png'
...
npx hardhat eval-img --network regtest --id '4' --offline false --contract '0x639453f46C75C1b4a43a8FdBA27B03b916748a44' --img 'sample-images/cifar10/airplane/0000.jpg'
