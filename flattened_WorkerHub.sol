...
// File contracts/interfaces/IInferable.sol

// Original license: SPDX_License_Identifier: UNLICENSED
pragma solidity ^0.8.0;

interface IInferable {
    function infer(bytes calldata data, address creator) external payable returns (uint256 inferenceId);
}


// File contracts/interfaces/IWorkerHub.sol
...
// File contracts/storages/WorkerHubStorage.sol
...
// File hardhat/console.sol@v2.22.10
