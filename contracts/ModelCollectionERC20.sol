...
import {ModelCollectionERC20Storage} from "./storages/ModelCollectionERC20Storage.sol";
import {TransferHelper} from "./lib/TransferHelper.sol";

contract ModelCollectionERC20 is
ModelCollectionERC20Storage,
EIP712Upgradeable,
...
OwnableUpgradeable {
    ...
    function mint(address _to, string calldata _uri, address _model, uint cost) external onlyManager returns (uint256) {
        if (cost < mintPrice) revert InsufficientFunds();
